...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 36.0, 332.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 296.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 120.0, 144.0, 33.0 ],
					"text" : "/tone = [/tone, 50]",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 36.0, 90.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /tone"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 36.0, 60.0, 179.0, 22.0 ],
					"style" : "",
					"text" : "route float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 36.0, 240.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "o.change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 36.0, 200.0, 87.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 36.0, 170.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "my-esplora"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 104.0, 240.0, 101.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					"comment" : "(float) frequency for tone generator",
					"id" : "obj-2",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 56.0, 358.0, 102.25, 358.0, 102.25, 290.0, 76.5, 290.0 ],
					"source" : [ "obj-7", 1 ]
				}
