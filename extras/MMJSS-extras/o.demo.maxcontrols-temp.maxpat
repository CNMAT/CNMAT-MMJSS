...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 135.0, 150.0, 20.0 ],
					"text" : "Double Click for Controls"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 398.0, 261.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 215.0, 124.0, 50.0, 20.0 ],
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.5, 8.0, 47.0, 20.0 ],
					"text" : "recall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 281.0, 32.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 8.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 35.5, 297.0, 12.0, 297.0, 12.0, 114.0, 255.5, 114.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "o.demo.maxcontrols.maxpat",
				"bootpath" : "/Users/jeffreylubow/Documents/Max/Packages/CNMAT-odot/examples",
				"patcherrelativepath" : "../../../CNMAT-odot/examples",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
