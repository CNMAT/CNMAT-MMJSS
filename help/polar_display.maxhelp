...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 176.0, 85.0, 18.0 ],
					"text" : "compile, draw"
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 140.0, 63.0, 20.0 ],
													"text" : "pack 0. 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 161.0, 100.0, 103.0, 20.0 ],
...
,
									"patching_rect" : [ 50.0, 236.0, 130.0, 20.0 ],
...
,
					"patching_rect" : [ 160.0, 120.0, 81.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 280.0, 55.0, 20.0 ],
									"text" : "o.collect"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 248.0, 110.0, 57.0, 20.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 130.0, 200.0, 41.0, 20.0 ],
									"text" : "zl.join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 130.0, 160.0, 137.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 130.0, 230.0, 37.0, 20.0 ],
									"text" : "o.var"
								}
...
,
					"patching_rect" : [ 40.0, 411.0, 63.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 144.0, 38.0, 20.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 40.0, 86.0, 151.0, 20.0 ],
					"text" : "o.route /horizontal /vertical"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 226.0, 170.0, 170.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 456.0, 190.0, 47.0 ],
					"text" : "/angle 59\n/dist 0.137739\n/coords -0.11811 -0.0708661",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 40.0, 56.0, 94.0, 20.0 ],
					"text" : "o.route /joystick"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 26.0, 73.0, 20.0 ],
					"text" : "o.io.esplora"
				}
...
, 			{
				"name" : "polar_display.js",
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/CNMAT-MMJSS/javascript",
