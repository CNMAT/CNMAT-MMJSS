...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 550.0, 400.0, 126.0, 25.0 ],
					"style" : "",
					"text" : "unpack 0. 0. 0. 0."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 87.0, 370.0, 167.0, 19.0 ],
									"style" : "",
									"text" : "...click here for even more info"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 57.0, 370.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.0, 398.0, 320.0, 33.0 ],
									"style" : "",
									"text" : ";\rmax launchbrowser https://en.wikipedia.org/wiki/HSL_and_HSV"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 233.0, 311.0, 105.0, 21.0 ],
									"style" : "",
									"text" : "hsl 0.055 1. 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 319.0, 217.0, 97.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 124.0, 217.0, 176.0, 70.0 ],
									"text" : "/hue : 0.055,\n/saturation : 1.,\n/luminance : 0.5,\n/to/swatch : [\"hsl\", 0.055, 1., 0.5]",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 33.0, 107.0, 88.0, 56.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 124.0, 33.549011, 73.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 124.0, 107.0, 260.0, 59.0 ],
									"text" : "/saturation = 1.,\n/luminance = 0.5,\n/to/swatch = [hsl, /hue, /saturation, /luminance]",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 124.0, 67.0, 73.0, 22.0 ],
									"style" : "",
									"text" : "o.pack /hue"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 605.455872, 120.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 325.0, 238.955872, 52.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.499992, 487.5, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.088242, 237.549011, 279.0, 33.0 ],
					"style" : "",
					"text" : "leftmost outlet of swatch outputs a list of 4 floats.  you will only need the first 3."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.911736, 427.0, 81.0, 20.0 ],
					"style" : "",
					"text" : "mic loudness"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.323486, 427.0, 39.0, 20.0 ],
					"style" : "",
					"text" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 427.0, 54.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 321.5, 480.0, 32.5, 25.0 ],
					"style" : "",
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 152.0, 92.0, 25.0 ],
					"style" : "",
					"text" : "pack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 377.0, 120.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 573.455872, 152.0, 115.0, 25.0 ],
					"style" : "",
